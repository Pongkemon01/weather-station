...
inline constexpr const char* kOrganizationName   = "RobinLab";
inline constexpr const char* kOrganizationDomain = "robin.ku.ac.th";
...
// ----- USB identification ---------------------------------------------------
// VID 0x1209 = pid.codes; PID 0xDCB1 = RobinLab Weather Station
