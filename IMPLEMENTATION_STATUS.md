...
Constraints: `host/CLAUDE.md` · Stack: Qt 6.8 Widgets + QSerialPort, C++17, MinGW-w64
...
| Ph2 | DeviceController request/response API — typed slots per opcode, `m_metaCache`, 1500 ms per-request timeout | ✓ 2026-05-14 |
| Ph3 | Status tab — 11 subsystem indicators, RTC display, Update RTC, Clear Database, Re-connect, 2 s poll | ✓ 2026-05-14 |
| Ph4 | Current Measurement tab — 7-row sensor table, 1 s `REQ_WEATHER` poll, Q9.7 conversion | ✓ 2026-05-14 |
| Ph5 | General Settings tab — Region/Station ID, Sampling Interval, server URLs; load/Apply/Discard via `m_metaCache` | ✓ 2026-05-14 |
| Ph6 | Sensor Settings tab — 5 calibration adjusts; shares `m_metaCache` with Ph5 | ✓ 2026-05-14 |
| Ph7 | About tab — icon, product name, copyright, version string | ✓ 2026-05-14 |
| Ph8 | Debug Log dialog — `LogBuffer` viewer, live tail, Copy All, Ctrl+L wire-up | ✓ 2026-05-14 |
| Ph9 | Build & package — new sources in CMakeLists, ctest clean, windeployqt portable zip | ✓ 2026-05-14 |

Test coverage: `tests/frame_parser_test.cpp` (13/13) · `tests/q97_conversion_test.cpp` (12/12) · `tests/device_controller_test.cpp` (9/9) — all pass.
...
| H2 host      | `DeviceController` frame routing — typed signals, cache, raw pass-through  | ✓ 9/9 — 2026-05-14 |
| H4 host      | Q9.7 fixed-point — round-trip, saturation, typical sensor values           | ✓ 12/12 — 2026-05-14 |

---

## Outstanding

**Host Application:** all phases complete (Ph0–Ph9). Portable zip: `host/packaging/RobinWSC-1.0.0-win64.zip` (12.4 MB).

**Firmware integration tests:** P1-9..P1-12, P2-5/6, P2.1-10..12, P3-7/8, P3.1-8..10, P3.2-6/7 and field/integration tests P4-1..P4-7. Server side: complete.
