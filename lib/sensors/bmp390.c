...
static float bmp390_compensate_temperature(uint32_t adc_temp)
{
    ...
    bmp32_calib_data.t_lin = partial_data2 + ((partial_data1 * partial_data1) * bmp390_calib_data.par_t3);
...
{
    static const uint8_t rst_cmd[2] = {BMP390_REG_CMD, BMP390_CMD_SOFT_RESET};
