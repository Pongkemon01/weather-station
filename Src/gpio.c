...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, LED_RED_Pin|LED_YELLOW_Pin|LED_GREEN_Pin|LED_BLUE_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : USR_SW1_Pin USR_SW2_Pin */
  GPIO_InitStruct.Pin = USR_SW1_Pin|USR_SW2_Pin;
